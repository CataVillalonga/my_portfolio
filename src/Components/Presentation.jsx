...
const Presentation =() => {
  return (
    <section className="presentation-section">
      <section className="presentation-section-info">
        <h1>Hello World!</h1>
        <p>
          Welcome to my website. My name is Catalina Villalonga, I'm a fullstack web developer with a passion for frontend. 
        </p>
        <li>
          <ul>  
            <a href='https://github.com/CataVillalonga' className="social-link social-link--github" id="github">
          ...
          <ul>
            <a href='https://www.linkedin.com/in/catalina-villalonga-7a272912a/' className="social-link social-link--linkedin" id="linkedin">
              <svg className="social-svg" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                <g className="social-group" fill="none" fillRule="evenodd">
                  <circle className="social-group__outline" stroke="#000" strokeWidth="20" cx="300" cy="300" r="262.5" />
      ...
      <section className="presentation-section-img">
        <img src={photo} alt="cover of developer" />
      </section>
    </section>
  )
}
